...
model = SentenceTransformer("/kaggle/input/fashion-semantic-model-sr/transformers/default/1/fashion-semantic-model-sr").to(device)
...
synthetic_file = "/kaggle/input/synthetic-sr-queries/synthetic_queries_keyword_sr_balanced.jsonl"
