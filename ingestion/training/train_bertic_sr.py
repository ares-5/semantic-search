...
out_file = "/kaggle/input/queries/generated_queries_all.tsv"

translator = Translator()

# Load T5-generated synthetic queries (eng)
train_examples = []
    ...
    for i, line in enumerate(fIn):
        try:
            ...
            if not row.empty:
                ...
                train_examples.append(InputExample(texts=[query_sr, abstract_sr]))
        except:
            continue
